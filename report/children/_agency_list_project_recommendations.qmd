...
has_request_locations <- any(!is.na(project_request_list[["location_asset_id"]]))
...
```{r}
gt_revenue_category_fy(
  project_request_list$request_data,
  title = paste0(
    "Total ",
...
#| fig-width: 2
#| fig-height: 2
plot_project_locations(project_request_list, size = 3, asset_data = )
```
